...
namespace Mecha.Core.Generator.DefaultGenerators.Utils
{
    ...
    public static class NegateValueLookup
    {
        ...
        public static Dictionary<int, Func<object, object>>? Negate { get; } = new Dictionary<int, Func<object, object>>
        {
            ...
            [typeof(short?).GetHashCode()] = (value) => -(short)(value ?? (short)0),
            [typeof(int?).GetHashCode()] = (value) => -(int)(value ?? 0),
            [typeof(long?).GetHashCode()] = (value) => -(long)(value ?? (long)0),
            [typeof(ushort?).GetHashCode()] = (value) => ushort.MaxValue - (ushort)(value ?? (ushort)0),
            [typeof(uint?).GetHashCode()] = (value) => uint.MaxValue - (uint)(value ?? (uint)0),
            [typeof(double?).GetHashCode()] = (value) => -(double)(value ?? (double)0),
            [typeof(float?).GetHashCode()] = (value) => -(float)(value ?? (float)0),
            [typeof(decimal?).GetHashCode()] = (value) => -(decimal)(value ?? (decimal)0),
            [typeof(bool?).GetHashCode()] = (value) => !(bool)(value ?? false),
