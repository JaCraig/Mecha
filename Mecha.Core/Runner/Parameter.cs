...
namespace Mecha.Core.Runner
{
    ...
    public class Parameter
    {
        ...
        /// <param name="createdBy">Parameter generated by.</param>
        public Parameter(ParameterInfo parameter, object? value, string createdBy)
        {
            ParameterInfo = parameter;
            if (value is not null && !parameter.ParameterType.IsAssignableFrom(value?.GetType()) && !parameter.ParameterType.IsSpecialType(out System.Type? _))
                value = null;
            if (value is null)
        ...
        public Parameter(ParameterInfo parameter, object? value, string createdBy, int shrinkCount, int mutationCount) : this(parameter, value, createdBy)
        {
        ...
        /// <summary>
        /// Get the generator that created the parameter value.
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public Parameter Copy() => new(ParameterInfo, Value, CreatedBy, ShrinkCount, MutationCount);
